...
public class EntityAIFear extends EntityAIAvoidEntity {
    ...
    public EntityAIFear(EntityCreature entityFearing, Class<? extends net.minecraft.entity.Entity> entityFeared, float distance, double farSpeed, double nearSpeed, float fearFactor)
    {
    ...
    public boolean continueExecuting()
    {
        ...
        if (this.theEntity.getDistanceToEntity(this.closestLivingEntity) > this.distanceFromEntity)
            return false;
