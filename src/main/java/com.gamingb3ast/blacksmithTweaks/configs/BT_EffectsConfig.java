...
public class BT_EffectsConfig extends Configuration{
    ...
    public void loadCFG()
	{
		...
		if(buffsCount != 0) {
			...
			throw new IllegalStateException("[Blacksmith Tweaks] No buffs were loaded, THIS IS EXPECTED FOR FIRST LAUNCHES OF THE CONFIG!! PLEASE RESTART THE GAME TO FIX THIS ISSUE!!");
